...
export const releases: ReleaseEntry[] = [
  ...
  },
  {
    ...
    notes: [
      'feature: Top-bar chat shortcut — Job Messages is now a shortcut in the top bar next to notifications, with an unread badge so you can jump in quickly.',
      'improvement: One conversation per job — The inbox lists one conversation per job (no duplicate job numbers) and opening it shows the full chat with a reply box.',
      'improvement: Sent, Read, or Unread — Each chat message shows Sent, Read (with time), or Unread so you can tell what’s new.',
      'improvement: Page size and sticky headers — Choose how many conversations to show per page (10–100), with the list and chat headers staying fixed while you scroll.',
      'improvement: Full-width messages page — The Job Messages page uses the same blue page header as other screens and spans the full width for easier reading.',
      'improvement: Moved out of Jobs menu — Job Messages no longer appears under the Jobs menu; use the top-bar chat icon instead.',
      'improvement: CSO welcome summary — What’s New welcome summary shows open follow-ups, pending jobs, completed today, and unread messages for CSOs.',
      'improvement: Clearer What’s New cards — Each update card now has its own short title instead of repeating the release name.',
    ],
  },
  {
    version: '3.18.0',
