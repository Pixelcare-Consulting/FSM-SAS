...
export const TrafficChartOptions = {
	...
	legend: { labels: { colors: [theme.gray500], useSeriesColors: !1 }, position: 'bottom' },
...
export const EarningsChartOptions = {
	...
	xaxis: {
		...
		axisTicks: { show: !1 },
		crosshairs: { show: !0 },
		labels: { style: { fontSize: "13px", fontWeight: 400, colors: theme.gray500, fontFamily: "Poppins" } },
	},
	yaxis: {
		labels: {
...
export const OperatingSystemChartOptions = {
	...
	plotOptions: {
		polarArea: {
			...
			spokes: { strokeWidth: 1, connectorColors: [theme.borderColor, theme.borderColor, theme.borderColor, theme.borderColor] },
		},
	},
	responsive: [
		{ breakpoint: 480, options: { chart: { height: 300 } } },
...
export const UserChartOptions = {
	...
	colors: [theme.primary],
	fill: { type: "gradient", gradient: { gradientToColors: [theme.primary], shadeIntensity: 0.9, opacityFrom: 0.5, opacityTo: 0.04, stops: [0, 80, 100] } },
...
export const VisitorChartOptions = {
	...
	dataLabels: { enabled: !1 },
	stroke: { curve: "smooth", width: 2 },
	fill: { colors: [theme.success], type: "gradient", gradient: { type: "vertical", gradientToColors: [theme.success], shadeIntensity: 0.7, opacityFrom: 0.5, opacityTo: 0.04, stops: [0, 80, 100] } },
	series: [{ name: "User", data: [28, 40, 36, 52, 38, 60, 55] }],
	xaxis: { labels: { show: !1 }, axisBorder: { show: !1 } },
	yaxis: [{ y: 0, offsetX: 0, offsetY: 0, padding: { left: 0, right: 0 } }],
	tooltip: { x: { show: !1 } }
...
export const AverageVisitTimeChartOptions = {
	...
	dataLabels: { enabled: !1 },
	stroke: { curve: "smooth", width: 2 },
	fill: { type: "gradient", gradient: { gradientToColors: [theme.danger], shadeIntensity: 0.7, opacityFrom: 0.5, opacityTo: 0.04, stops: [0, 80, 100] } },
	series: [{ name: "User", data: [28, 40, 36, 52, 38, 60, 55] }],
	xaxis: { labels: { show: !1 }, axisBorder: { show: !1 } },
	yaxis: [{ y: 0, offsetX: 0, offsetY: 0, padding: { left: 0, right: 0 } }],
	tooltip: { x: { show: !1 } },
...
export const BudgetExpenseChartOptions = {
	...
	plotOptions: { radar: { size: 150, offsetX: 0, offsetY: 0, polygons: { strokeColors: theme.borderColor, strokeWidth: 1, connectorColors: theme.borderColor, fill: { colors: void 0 } } } },
	xaxis: {
		categories: ["Design", "SaaS Services", "Development", "SEO", "Entertainment", "Marketing"],
		labels: {
			show: !0,
			style: { colors: [theme.gray400, theme.gray400, theme.gray400, theme.gray400, theme.gray400, theme.gray400], fontSize: "14px", fontFamily: "Poppins", fontWeight: 600 },
		},
	},
	responsive: [
		{
...
export const TaskSummaryChartOptions = {
	...
	yaxis: { labels: { style: { fontSize: "13px", fontWeight: 400, colors: theme.gray500, fontFamily: "Poppins" } } },
	grid: { borderColor: theme.borderColor },
};
