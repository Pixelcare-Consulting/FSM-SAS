...
import { isLocationOptionActive } from "./filterActiveLocationOptions";

export {
  filterActiveLocationOptions,
  isLocationOptionActive,
  locationOptionIdentityKeys,
  normalizeLocationOptionStatus,
} from "./filterActiveLocationOptions";
...
export function locationSelectOptionLabel(option) {
  ...
  const inactive = !isLocationOptionActive(option);
