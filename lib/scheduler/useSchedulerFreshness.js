...
import {
  ...
  shouldSkipOwnTechnicianJobsRealtime,
  windowCacheKey,
...
export function useSchedulerFreshness({
  ...
  }, [viewMode, selectedDate, includeUndated, refreshData]);
  ...
  useEffect(() => {
    ...
    const onTechnicianJobsChange = (payload) => {
      if (shouldSkipOwnTechnicianJobsRealtime(payload)) return;
