...
export const queryKeys = {
  ...
  jobMessagesList: (params) =>
    params ? ['jobs', 'messages', 'list', params] : ['jobs', 'messages', 'list'],
  jobMessagesUnreadCount: (params) =>
    params
      ? ['jobs', 'messages', 'unread-count', params]
      : ['jobs', 'messages', 'unread-count'],
