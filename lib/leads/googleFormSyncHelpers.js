...
import { allocateNextPortalCustomerCodes } from '../supabase/portalCustomerCodes';
...
/**
 * Reserve the next N unused portal CP codes (numeric max, skip occupied including soft-deleted).
...
export async function reservePortalCustomerCodes(supabase, count) {
  ...
  return allocateNextPortalCustomerCodes(supabase, count);
}
