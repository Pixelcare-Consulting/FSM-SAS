...
function mapPersonalData(userData, technician) {
  return {
    profilePicture: technician?.avatar_url || userData?.avatar_url || "/images/avatar/NoProfile.png",
...
export function mapCoreToViewTechnician({ userData, technician, technicianId, hasTechnicianRecord }) {
  ...
  return {
    ...
    city: "",
    country: "",
    profilePicture: userData?.avatar_url || "/images/avatar/NoProfile.png",
    bio: "",
